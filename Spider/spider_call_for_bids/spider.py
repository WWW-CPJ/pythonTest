                ...
                if match:
                    ...
                    try:
                        iframe = WebDriverWait(driver, 10).until(
                            EC.presence_of_element_located((By.CSS_SELECTOR, 'iframe[src*="https://i-cn.vaptcha.com/cn/p-test-vip.html?v=1.0.22"]'))
                        )
                        driver.switch_to.frame(iframe)

                        captcha_imgn= WebDriverWait(driver, 10).until(
                            EC.presence_of_element_located((By.CSS_SELECTOR, '#vaptcha > div > div.vp-code > div.vp-main-bg > canvas'))
                        )
                        print("找到图片")
                    ...
                    captcha_img = driver.find_element(By.CSS_SELECTOR, '#vaptcha > div > div.vp-code > div.vp-main-bg > canvas')
