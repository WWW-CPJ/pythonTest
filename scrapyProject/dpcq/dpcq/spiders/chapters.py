...
class ChaptersSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        novel_chapters = response.xpath('//div[@class="m-book-list"]/div[@id="play_0"]/ul/li/a/text()').getall()[0:50]
        ...
        novel_chapters_links = response.xpath('//div[@class="m-book-list"]/div[@id="play_0"]/ul/li/a/@href').getall()[0:50]
